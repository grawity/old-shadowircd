/*
 *  UltimateIRCd - an Internet Relay Chat Daemon, src/rc4.c
 *
 ...
 *  USA
 *
 *  $Id: rc4.c,v 1.1 2003/11/04 07:11:08 nenolod Exp $
 *
 */
...
void *
rc4_initstate (unsigned char *key, int keylen)
{
  RC4DWORD i;
  ...
  if (sizeof (RC4BYTE) != 1)
    abort ();			/* MUST BE 1 BYTE! */
  if (sizeof (RC4DWORD) != 4)
    abort ();			/* MUST BE 4 BYTES! */
...
void
rc4_process_stream (void *rc4_context, unsigned char *istring,
...
void
rc4_process_stream_to_buf (void *rc4_context, const unsigned char *istring,
