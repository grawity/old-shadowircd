 ...
 *  USA
 *
 *  $Id: ssl.c,v 1.1 2003/11/04 07:11:13 nenolod Exp $
 *
 */
...
fatal_ssl_error (int ssl_error, int where, aClient * source_p)
{
  ...
  switch (where)
    ...
    default:
      ssl_func =
	"undefined SSL func [this is a bug] reporto to Ultimate-Devel@Shadow-Realm.org";
    }
  ...
  sendto_snomask (SNOMASK_DEBUG, "%s to "
