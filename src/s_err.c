 ...
 *  USA
 *
 *  $Id: s_err.c,v 1.1 2003/11/04 07:11:14 nenolod Exp $
 *
 */
...
static char *replies[] = {
  /* 000 */ NULL,
  /* 001 RPL_WELCOME */ ":%s 001 %s :Welcome to %s, %s!",
  /* 002 RPL_YOURHOST */
  ":%s 002 %s :Your host is %s, running %s",
  /* 003 RPL_CREATED */
  ":%s 003 %s :This server was cobbled together on %s",
  /* 004 RPL_MYINFO */ ":%s 004 %s %s %s %s %s %s",
  /* 005 RPL_PROTOCTL */ ":%s 005 %s %s :are available on this server",
  /* 006 RPL_MAP */ ":%s 006 %s :%s%-*s (Users:%5d)  (%2d%%)",
  ...
  /* 098 */ NULL,
  /* 099 */ NULL,
  /* 100 RPL_SNOMASKIS */ ":%s 100 %s :Server Notice Mask (+%s)",
  /* 101 */ NULL,
  /* 102 */ NULL,
  /* 103 */ NULL,
  /* 104 */ NULL,
  ...
  /* 204 RPL_TRACEOPERATOR */ ":%s 204 %s Operator %d %s %ld",
  /* 205 RPL_TRACEUSER */ ":%s 205 %s User %d %s %ld",
...
# ifdef HIGHEST_CONNECTION
  ...
  /* 252 RPL_LUSEROP */ ":%s 252 %s %d :flagged staff members online",
...
#ifdef DEBUGMODE
  /* 351 RPL_VERSION */
  ":%s 351 %s %s %s :RelStatus=%s ServOpts=%s Proto=%l Debug=%s",
#else
  /* 351 RPL_VERSION */
  ":%s 351 %s %s %s :RelStatus=%s ServOpts=%s Proto=%l %s",
#endif
  ...
  /* 376 RPL_ENDOFMOTD */ ":%s 376 %s :End of /MOTD.",
  /* 377 */ NULL,
  /* 378 */ NULL,
  /* 379 */ NULL,
  /* 380 */ NULL,
  /* 381 RPL_YOUREOPER */ ":%s 381 %s :You are now a deity! Play nice or else.",
  ...
  ":%s 405 %s %s :You have exceeded the maximum amount of channels allowed to be on at one time",
  ...
  ":%s 408 %s %s :You cannot use colors on this channel. Not sent: %s",
  ...
  /* 428 */ NULL,
  /* 429 ERR_TOOMANYAWAY */
  ":%s 429 %s :Too many aways - flood protection activated",
  /* 430 */ NULL,
  ...
  /* 434 */ NULL,
  /* 435 ERR_BANONCHAN */
  ":%s 435 %s %s %s :Cannot change to a banned nickname",
  /* 436 ERR_NICKCOLLISION */ ":%s 436 %s %s :Nickname collision KILL",
  /* 437 ERR_BANNICKCHANGE */
  ":%s 437 %s %s :Cannot change nickname while banned or moderated on channel",
  /* 438 */ NULL,
  /* In use by Undernet - ERR_NICKTOOFAST */
  /* 439 ERR_TARGETTOOFAST */
  ":%s 439 %s %s :Message target change too fast. "
    "Please wait %d seconds and then try again.",
  /* 440 ERR_SERVICESDOWN */
  ":%s 440 %s %s :Services are currently down. Please wait a few moments, and then try again.",
  ...
  ":%s 463 %s :Your host isn't among the privileged",
  /* 464 ERR_PASSWDMISMATCH */
  ":%s 464 %s :Password invalid, please try again or contact server administrator.",
  ...
  ":%s 468 %s %s :Only servers can change that mode",
  /* 469 */ NULL,
  /* 470 ERR_NOPERMISSION */ ":%s 470 %s :Not enough permission to [%s] to [%s]. User is [%s], while you are [%s].",
  /* 471 ERR_CHANNELISFULL */
  ":%s 471 %s %s :Cannot join channel, channel is full (+l)",
  /* 472 ERR_UNKNOWNMODE */ ":%s 472 %s %c :is unknown mode char to me",
  /* 473 ERR_INVITEONLYCHAN */
  ":%s 473 %s %s :Cannot join channel, channel is invite only (+i)",
  /* 474 ERR_BANNEDFROMCHAN */
  ":%s 474 %s %s :Cannot join channel, you are banned from channel (+b)",
  /* 475 ERR_BADCHANNELKEY */
  ":%s 475 %s %s :Cannot join channel, channel requires valid key (+k)",
  /* 476 ERR_BADCHANMASK */ ":%s 476 %s %s :Bad Channel Mask",
  /* 477 ERR_NEEDREGGEDNICK */
  ":%s 477 %s %s :Cannot join channel, channel allows identified users only (+R)",
  /* 478 ERR_BANLISTFULL */ ":%s 478 %s %s %s :Channel ban list is full",
  /* 479 ERR_BADCHANNAME */
  ":%s 479 %s %s :Channel name contains illegal characters",
  /* 480 ERR_SERVERONLY */
  ":%s 480 %s :Permission denied. Only servers may use this command.",
  /* 481 ERR_NOPRIVILEGES */
  ":%s 481 %s :You can't do that! You're not a deity!",
  /* 482 ERR_CHANOPRIVSNEEDED */
  ":%s 482 %s %s :Permission denied, you do not have the correct channel access privileges",
  /* 483 ERR_CANTKILLSERVER */ ":%s 483 %s :You cant kill a server!",
  /* 484 */ NULL,
  /* In use by Undernet */
  /* 485 ERR_CHANBANREASON */ ":%s 485 %s %s :Cannot join channel (%s)",
  /* 486 ERR_SSLCLIENTSONLY */
  ":%s 486 %s %s :Cannot join channel, channel allows secure clients only (+S)",
  /* 487 */ NULL,
  /* 488 */ NULL,
  /* 489 */ NULL,
  /* In use by Undernet */
  ...
  ":%s 512 %s %s :Maximum size for WATCH-list is 128 entries",
  /* 513 */ NULL,
  /* In use by Undernet */
  /* 514 ERR_TOOMANYDCC */
  ":%s 514 %s %s :Your dcc allow list is full. Maximum size is %d entries",
  /* 515 */ NULL,
  /* 516 */ NULL,
  /* 517 */ NULL,
  /* 518 */ NULL,
  ...
  /* 520 */ NULL,
  /* 521 ERR_LISTSYNTAX */
  ":%s 521 %s :Bad list syntax, type /quote list ? or /raw list ?",
  /* 522 ERR_WHOSYNTAX */
  ...
  /* 603 RPL_WATCHSTAT */
  ":%s 603 %s :You have %d and are on %d WATCH entries",
  ...
  /* 608 */ NULL,
  /* Do not use -- Reserved for WATCH -Rak */
  /* 609 */ NULL,
  /* 610 */ NULL,
  /* 611 */ NULL,
  /* 612 */ NULL,
  /* 613 RPL_WHOISSERVICES */ ":%s 613 %s %s :is a Services Client",
  /* 614 RPL_WHOISHELPOP */ ":%s 614 %s %s :is available for help",
  /* 615 RPL_WHOISMODES */ ":%s 615 %s %s :is using modes %s %s",
  /* 616 RPL_WHOISHOST */ ":%s 616 %s %s :real hostname %s %s",
  ...
  /* 628 */ NULL,
  /* 629 */ NULL,
  /* 630 RPL_SETTINGS */ ":%s 630 %s :%s",
  /* 631 RPL_ENDOFSETTINGS */ ":%s 631 %s :End of /SETTINGS",
  /* 632 RPL_IRCOPS */ ":%s 632 %s :%s",
  /* 633 RPL_ENDOFIRCOPS */ ":%s 633 %s :End of /IRCOPS",
  /* 634 */ NULL,
  /* 635 */ NULL,
  /* 636 */ NULL,
  /* 637 */ NULL,
  /* 638 */ NULL,
  /* 639 */ NULL,
  /* 640 RPL_OPERMOTDSTART */
  ":%s 640 %s :- %s Operator message of the Day - ",
  /* 641 RPL_OPERMOTD */ ":%s 641 %s :- %s",
  /* 642 RPL_ENDOFOPERMOTD */ ":%s 642 %s :End of /OPERMOTD command.",
  /* 643 */ NULL,
  /* 644 RPL_RULESSTART */ ":%s 644 %s :- %s Rules - ",
  /* 645 RPL_RULES */ ":%s 645 %s :- %s",
  /* 646 RPL_ENDOFRULES */ ":%s 646 %s :End of /RULES command.",
  /* 647 */ NULL,
  /* 648 */ NULL,
  /* 649 */ NULL,
  /* 650 RPL_MAPMORE */ ":%s 650 %s :%s%-*s --> *more*",
  /* 651 */ NULL,
  /* 652 */ NULL,
  /* 653 */ NULL,
  /* 654 */ NULL,
  ...
  /* 658 */ NULL,
  /* 659 */ NULL,
  /* 660 RPL_STATSVLINE */ ":%s 660 %s %c %s * %s %d %d",
  /* 661 */ NULL,
  /* 662 */ NULL,
  /* 663 */ NULL,
  /* 664 */ NULL,
  ...
  /* 669 */ NULL,
  /* 670 */ NULL,
  /* 671 RPL_WHOHOST */ ":%s 671 %s %s real hostname %s %s",
  /* 672 */ NULL,
  /* 673 */ NULL,
  /* 674 */ NULL,
  /* 675 */ NULL,
  ...
  /* 698 */ NULL,
  /* 699 */ NULL,
  /* 700 ERR_EXEMPTLISTFULL */
  ":%s 700 %s %s %s :Channel exempt list is full",
  /* 701 */ NULL,
  /* 702 */ NULL,
  /* 703 */ NULL,
  /* 704 */ NULL,
  ...
  /* 708 */ NULL,
  /* 709 */ NULL,
  /* 710 ERR_NORULES */ ":%s 710 %s :RULES File is missing",
  /* 711 ERR_NOOPERMOTD */ ":%s 711 %s :OPERMOTD File is missing",
  /* 712 */ NULL,
  /* 713 */ NULL,
  /* 714 */ NULL,
  /* 715 */ NULL,
