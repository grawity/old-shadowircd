 ...
 *  USA
 *
 *  $Id: channel.h,v 1.1 2004/07/29 15:28:07 nenolod Exp $
 */
...
extern void qs_user_from_channels(struct Client *);
...
void set_channel_topic(struct Channel *chptr, const char *topic, const char *topic_info,
		       time_t topicts);
