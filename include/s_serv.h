 ...
 *  USA
 *
 *  $Id: s_serv.h,v 1.1 2004/07/29 15:28:00 nenolod Exp $
 */
...
#define CAP_TB		0x00040000	/* supports TBURST */
...
extern int hunt_server(struct Client *client_pt,
		       struct Client *source_pt, const char *command, int server, int parc, char **parv);
