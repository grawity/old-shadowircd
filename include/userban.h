/*
 *  UltimateIRCd - an Internet Relay Chat Daemon, include/userban.h
 *
 ...
 *  USA
 *
 *  $Id: userban.h,v 1.1 2003/11/04 07:11:57 nenolod Exp $
 *
 */
...
void report_userbans_match_flags(aClient *client_p, unsigned int, unsigned int);
