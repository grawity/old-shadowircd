...
/* server flags */
#define CONF_FLAGS_ALLOW_AUTO_CONN      0x00020000
#define CONF_FLAGS_LAZY_LINK            0x00040000
#define CONF_FLAGS_ENCRYPTED            0x00080000
#define CONF_FLAGS_COMPRESSED           0x00100000
#define CONF_FLAGS_TEMPORARY            0x00200000
...
extern struct ConfItem *x_temp_conf;
...
extern int attach_confs(struct Client *client, const char *name, int statmask);
...
extern struct ConfItem *find_conf_exact(const char *name, const char *user, const char *host,
					int statmask);
...
extern struct ConfItem *find_x_conf_exact(const char *);
...
extern void cleanup_temp_xlines(void *);
