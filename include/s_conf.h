 ...
 *  USA
 *
 *  $Id: s_conf.h,v 3.7 2004/09/25 17:30:21 nenolod Exp $
 */
...
struct AccessItem
{
  ...
  int              encrypted;
  int              aftype;
  char *           usermodes; /* Usermodes to assign upon successful oper */
#ifdef HAVE_LIBCRYPTO
...
struct server_info
{
  ...
  char *network_name;
  char *network_desc;
  char *network_operhost;
  char *network_glineaddr;
  char *network_cloakkey1;
  char *network_cloakkey2;
  char *network_cloakkey3;
