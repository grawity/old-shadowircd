 ...
 *
 *   $Id: example_module.c,v 1.1 2004/07/29 15:28:28 nenolod Exp $
 */
...
struct Message test_msgtab = {
 ...
 /* Fields are in order:
  *-> {unregged, regged, remote, encap, oper}
  *
  * where:
  ...
  * encap == function to call when received over ENCAP
  ...
  */
  {mr_test, m_test, ms_test, m_ignore, mo_test}
