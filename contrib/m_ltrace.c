 ...
 *  USA
 *
 *  $Id: m_ltrace.c,v 1.1 2004/07/29 15:28:26 nenolod Exp $
 */
...
struct Message ltrace_msgtab = {
  ...
  {m_unregistered, m_ltrace, m_ltrace, m_ignore, m_ltrace}
};

#ifndef STATIC_MODULES
int h_doing_ltrace_id;

void
_modinit(void)
{
  hook_add_event("doing_ltrace", &h_doing_ltrace_id);
                     ...
                     int parc, char *parv[])
{
  ...
  hook_call_event(h_doing_ltrace_id, source_p);
