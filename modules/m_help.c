 ...
 *  USA
 *
 *  $Id: m_help.c,v 1.1 2004/07/29 15:27:45 nenolod Exp $
 */
...
static void dohelp(struct Client *, const char *, char *, const char *);
static void sendhelpfile(struct Client *, const char *, const char *, const char *);

struct Message help_msgtab = {
	"HELP", 0, 0, 0, 0, MFLG_SLOW, 0,
	{m_unregistered, m_help, m_ignore, m_ignore, mo_help}
};

struct Message uhelp_msgtab = {
	"UHELP", 0, 0, 0, 0, MFLG_SLOW, 0,
	{m_unregistered, m_help, m_ignore, m_ignore, mo_uhelp}
};
