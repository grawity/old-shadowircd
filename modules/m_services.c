 ...
 * 
 * $Id: m_services.c,v 1.3 2004/07/29 18:29:19 nenolod Exp $
 */
...
struct Message botserv_msgtab = {
  ...
  {m_unregistered, m_botserv, m_ignore, m_ignore, m_botserv}
};
struct Message hostserv_msgtab = {
  "HOSTSERV", 0, 0, 1, 0, MFLG_SLOW, 0,
  {m_unregistered, m_hostserv, m_ignore, m_ignore, m_hostserv}
};
