 ...
 *  USA
 *
 *  $Id: m_info.c,v 1.1 2004/07/29 15:27:45 nenolod Exp $
 */
...
struct Message info_msgtab = {
	...
	{m_unregistered, m_info, ms_info, m_ignore, mo_info}
};
...
static struct InfoStruct info_table[] = {
	...
	},
	{
		...
		"Minimum CIDR bitlen of ipv4 glines"
	},
	{
		"gline_min_cidr6",
		OUTPUT_DECIMAL,
		&ConfigFileEntry.gline_min_cidr6,
		"Minimum CIDR bitlen of ipv6 glines"
	},
	{
		"hide_error_messages",
		OUTPUT_BOOLEAN2,
	...
	},
	{
	  ...
	  "MAP is only allowed by operators",
	},
	{
	 ...
	 },
	{
	 ...
	 "Links rehash delay"},
	{
	 "hidden_oper_confonly",
	 OUTPUT_BOOLEAN_YN,
	 &ConfigFileEntry.hidden_oper_confonly,
	 "hidden_oper umode (+p) can't be changed by client"},
	/* --[  END OF TABLE  ]---------------------------------------------- */
	{
	 (char *) 0,
	 (unsigned int) 0,
...
m_info(struct Client *client_p, struct Client *source_p, int parc, char *parv[])
{
	...
	hook_call_event(h_doing_info_id, source_p);
