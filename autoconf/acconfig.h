/*
 * include/setup.h.in.  Generated automatically from configure.in by
 * autoheader.
 */
...
/* Define this if we have a sys_errlist */
#undef SYS_ERRLIST_DECLARED

/* Define this if we have (fd_set *)->read_bits */
...
/* Define if using rc4.c and dh.c */
#undef HAVE_ENCRYPTION_ON

/* Define if using Client SSL */
#undef USE_SSL

/* Define the nicklen. Hehe. */
#undef NICKLEN

/* Define the topiclen. Hehe. */
#undef TOPICLEN

/* Define the SPATH/DPATH */
#undef SPATH
#undef DPATH

/* Do we want throttling? */
#undef THROTTLE_ENABLE

/* Operator Password Encryption? */
#undef CRYPT_OPER_PASSWORD

/* Old stuff that will be moving to dynconf follows. */

/* Define this if you want to use SPLITCODE. */
#undef NO_CHANOPS_WHEN_SPLIT

/* Define this if you want to receive stats notices. */
#undef STATS_NOTICE
